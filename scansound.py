...
#logspace: np.logspace(np.log10(30),np.log10(20000), 64)
for freq in piano_freqs: #logspace generates an array of evenly spaced numbers, 64 between 30 &
...
wavfile.write('t.wav', rate=44000, data=summed_array.astype('float32'))
